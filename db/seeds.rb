...
movie.reviews.create!(name: "Roger Ebert", location: "LA", stars: 3, comment: "I laughed, I cried, I spilled my popcorn!")
movie.reviews.create!(name: "Gene Siskel", location: "Santa Barbara", stars: 5, comment: "I'm a better reviewer than he is.")
movie.reviews.create!(name: "Peter Travers", location: "Chicago, IL", stars: 4, comment: "It's been years since a movie superhero was this fierce and this funny.")

movie = Movie.find_by(title: 'Superman')
movie.reviews.create!(name: "Elvis Mitchell", location: "Philly", stars: 5, comment: "It's a bird, it's a plane, it's a blockbuster!")
